...
SCRIPT_DIR="$1"
TEST_PORT=$2
EXPECTED_RESPONSE_FILE="${SCRIPT_DIR}/../test_static_root/test_sudo-rm-rf-command.jpeg"
...
curl -k --output "$ACTUAL_RESPONSE_FILE" -s -S https://localhost:$TEST_PORT/static/test_sudo-rm-rf-command.jpeg -H "User-Agent:"
